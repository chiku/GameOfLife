...
env.Program('bin/golc', ['src/interfaces/curses/curses.c', 'lib/libgol.a', 'lib/libgol_ev.a'], LIBS=['ncurses'])
env.Program('bin/golX', ['src/interfaces/Xlib/graphics.c', 'src/interfaces/Xlib/Xlib.c', 'lib/libgol.a', 'lib/libgol_ev.a'], LIBS=['X11'])
