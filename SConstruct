...
env.StaticLibrary('lib/gol', Split(['src/coordinates.c', 'src/cell.c', 'src/rules.c', 'src/world.c']))
env.SharedLibrary('lib/gol', Split(['src/coordinates.c', 'src/cell.c', 'src/rules.c', 'src/world.c']))
